...
Ext.onReady(function() {
    ...
    Ext.define("Ext.locale.lv.form.field.Number", {
        ...
        minText: "Minimāla vērtība šim laukam ir  {0}",
        maxText: "Maksimāla vērtība šim laukam ir  {0}",
    ...
    if (exists('Ext.form.field.VTypes')) {
        Ext.apply(Ext.form.field.VTypes, {
            emailText: 'Šajā laukā jāieraksta e-pasta adrese formātā "lietotājs@domēns.lv"',
